            ...
            <div class="col-full">
                ...
                <div class="featured">
                    ...
                    <div class="featured__column featured__column--big">
                        ...
                        <div class="entry" style="background-image:url('{{$article->iamge}}');">

                            <div class="entry__content">
                                <span class="entry__category"><a href="#0">{{$article->categories->first() ? $article->categories->first()->name : ''}}</a></span>

                                <h1><a href="#0" title="">{{$article->tile}}.</a></h1>

                                <div class="entry__info">
                                    <a href="#0" class="entry__profile-pic">
                                        <img class="avatar" src="{{$article->employees->images}}" alt="">
                                    </a>

                                    <ul class="entry__meta">
                                        <li><a href="#0">{{$article->employees->name}}</a></li>
